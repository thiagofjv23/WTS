...
import { isRegularOpen } from "./athleteProfile.js";
import { plannedOpenField } from "./openPlanner.js";
...
export function selectParticipants(world, competition, categoryId, random, opts = {}) {
  ...
  // Opens comuns (G-1/G-2): o campo vem do PLANO anual dos atletas (decisão de
  // calendário no início do ano). Ver openPlanner.js / docs/ATHLETE_PROFILE.md.
  if (isRegularOpen(competition, rules)) {
    return plannedOpenField(world, competition, eligible, fieldSize, minField);
  }
